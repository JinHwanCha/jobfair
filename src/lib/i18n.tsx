...
const translations = {
  ...
  'apply.birthYear': { ko: '출생년도', en: 'Birth Year', zh: '出生年份' },
  'apply.birthYearPlaceholder': { ko: '예: 2000', en: 'e.g. 2000', zh: '例：2000' },
  'apply.birthYearHint': { ko: '예: 2000년생 → 2000', en: 'e.g. Born in 2000 → 2000', zh: '例：2000年出生 → 2000' },
