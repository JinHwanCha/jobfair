...
const translations = {
  ...
  'resume.noticeItem1': { ko: '행사 당일 원활한 진행을 위해 오후 2시30분까지 웰컴등록을 해주시면 감사하겠습니다.', en: 'For the smooth running of the event, please complete welcome registration by 2:30 PM on the day of the event. Thank you.', zh: '为了活动当天顺利进行，请在下午2点30分之前完成欢迎登记。谢谢您的配合。' },
  'resume.noticeItem2': { ko: '직업박람회는 오후 2시30분부터 진행 예정입니다. 감사합니다.', en: 'The Job Fair is scheduled to begin at 2:30 PM. Thank you.', zh: '职业博览会将于下午2点30分开始，敬请期待。谢谢。' },
