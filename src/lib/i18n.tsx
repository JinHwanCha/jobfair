...
const translations = {
  ...
  'resume.subtitle': { ko: '전문 멘토에게 자소서 첨삭을 받아보세요 (선착순 12명)', en: 'Get your resume reviewed by expert mentors (first 12 applicants)', zh: '由专业导师帮您修改简历（先到先得，限12人）' },
  ...
  'resume.writeDesc': { ko: '멘토가 검토할 자소서를 작성해주세요. 첨삭받고 싶은 내용을 자유롭게 입력하세요.', en: 'Write the resume you want reviewed. Feel free to include any content you want feedback on.', zh: '请撰写您希望导师审阅的简历。自由输入您想获得反馈的内容。' },
  'resume.writePlaceholder': { ko: '자소서 내용을 입력해주세요...\n\n예시:\n[지원동기]\n저는 어릴 때부터...\n\n[성장과정]\n...', en: 'Enter your resume content here...\n\nExample:\n[Motivation]\nSince I was young...\n\n[Growth]\n...', zh: '请输入您的简历内容...\n\n示例：\n[申请动机]\n从小我就...\n\n[成长过程]\n...' },
  ...
  'resume.consentItem1': { ko: '수집 항목: 이름, 생년월일, 휴대폰 번호 뒷자리, 학과, 희망직군, 자소서 내용', en: 'Collected: name, DOB, phone last 4, major, desired field, resume content', zh: '收集项目：姓名、出生日期、手机后4位、专业、希望职业、简历内容' },
