...
const translations = {
  ...
  'resume.noticeItem1': { ko: '행사 당일 원활한 진행을 위해 오후 2시 30분까지 웰컴등록을 해주시면 감사하겠습니다.', en: 'For the smooth running of the event, please complete welcome registration by 2:30 PM on the day of the event. Thank you.', zh: '为了活动当天顺利进行，请在下午2点30分之前完成欢迎登记。谢谢您的配合。' },
  'resume.noticeItem2': { ko: '직업박람회는 오후 2시 50분부터 진행 예정입니다. 감사합니다.', en: 'The Job Fair is scheduled to begin at 2:50 PM. Thank you.', zh: '职业博览会将于下午2点50分开始，敬请期待。谢谢。' },
  ...
  'resume.fieldRequired': { ko: '필수 항목입니다', en: 'This field is required', zh: '此项为必填项' },
  'resume.birthYearRequired': { ko: '출생년도를 확인해주세요', en: 'Please confirm your birth year', zh: '请确认出生年份' },
  'resume.companyTypeRequired': { ko: '기업 유형을 1개 이상 선택해주세요', en: 'Please select at least one company type', zh: '请至少选择一种企业类型' },
  ...
  // ── 김교은 멘토 불참 공지 ──
  'kimGyoeun.applyBannerTitle': {
    ko: '📢 김교은 멘토 관련 안내',
    en: '📢 Notice about Mentor 김교은',
    zh: '📢 关于导师김교은的通知',
  },
  'kimGyoeun.applyBannerDesc': {
    ko: '아쉽게도 김교은 멘토가 당일 사정으로 직접 참석이 어렵게 되었어요. 오픈카톡방을 통해 별도로 멘토링이 이어질 예정이에요.',
    en: "Unfortunately, mentor 김교은 won't be able to attend in person on the day. Mentoring will continue through the open KakaoTalk chat.",
    zh: '很遗憾，김교은导师当天有事无法亲自到场。将通过开放聊天室另行安排导师辅导。',
  },
  'kimGyoeun.openKakao': {
    ko: '오픈카톡방 바로가기',
  ...
  'kimGyoeun.modalNotice': {
    ko: '아쉽게도 김교은 멘토는 부득이한 사정으로 이번 직업박람회에 직접 오시기 어렵게 되었습니다. 오픈카톡방을 통해 별도로 멘토링이 이어질 예정이니 참고부탁드립니다.',
    en: "Unfortunately, mentor 김교은 is unable to attend the Job Fair in person. Mentoring will be arranged via the open KakaoTalk chat — we hope you'll still connect! :)",
    zh: '很遗憾，김교은导师因不可避免的原因无法亲自出席本次职业博览会。将通过开放聊天室单独安排导师辅导，敬请期待。',
  },
  'kimGyoeun.myPageNotice': {
    ko: '아쉽게도 김교은 멘토가 당일 사정으로 직접 참석이 어렵게 되었습니다. 아래 오픈카톡방을 통해 별도로 멘토링이 진행될 예정이니 참고해 주세요.',
    en: "Unfortunately, mentor 김교은 is unable to attend in person. Mentoring will be held separately via the open KakaoTalk chat below.",
    zh: '很遗憾，김교은导师当天无法亲自到场。将通过以下开放聊天室单独安排导师辅导，请了解。',
  },
  'kimGyoeun.myPageWarning': {
